...
class Profile extends React.Component {
  ...
  onDeleteSubmit = () => {
    ...
    fetch(
      `https://jsxneko-face-recognition-api.herokuapp.com/profile/${user.id}`,
      {
        method: "DELETE",
  ...
  onSubmitInfoChange = () => {
    let { nameChange, emailChange, passwordChange, confirmPasswordChange } =
      this.state;
    ...
    if (confirmPasswordChange === "" || confirmPasswordChange.length === 0)
      confirm_password = "";
      ...
      <article className="br0 shadow-5 ba mb5 b--black w-100 w-50-m w-25-l center">
        <main className="pa4 black-80">
              ...
              <div className="mt3">
                ...
                <div className="input-container">
                  <svg
                    ...
                    height="40"
                    fill="currentColor"
                    className="white bg-black pa1 bi bi-person"
                    viewBox="0 0 16 16"
                  >
              ...
              <div className="mt3">
                ...
                <div className="input-container">
                  <svg
                    ...
                    height="40"
                    fill="currentColor"
                    className="pa1 white bg-black bi bi-envelope"
                    viewBox="0 0 16 16"
                  >
              ...
              <div className="mv3">
                ...
                <div className="input-container">
                  <svg
                    ...
                    height="40"
                    fill="currentColor"
                    className="pa1 bi bi-key white bg-black"
                    viewBox="0 0 16 16"
                  >
          ...
          <div>
            ...
            >
              <div className="input-container">
                ...
                <span className="link" onClick={this.handleCloseModal}>
                  X
                </span>
              </div>
              ...
              <div>
                <p className="mb4 f4">
                  ...
                  retrieved. To delete your account, enter your current
                  password.
                </p>
                <input
                  className="center b pa2 input-reset ba b--black bg-transparent w-80"
                  type="password"
          ...
          <div className="mt2">
            ...
            <br />
            <input
              className="mt2 b ph3 pv2 input-reset ba b--black bg-red grow pointer f6 dib"
              type="submit"
